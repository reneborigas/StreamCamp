...
import com.navii.streamcamp.databinding.CampfireLayoutBinding;
...
public class CompleteActivity extends AppCompatActivity {
    ...
    private CampfireLayoutBinding binding;
    private PeerConnection peerConnection;
    private EglBase rootEglBase;
    private PeerConnectionFactory factory;
    private VideoTrack videoTrackFromCamera;
    private Boolean isCampMaster ;
    private static final String VIDEO_TRACK_ID = "ARDAMSv0";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.campfire_layout);
        isCampMaster = getIntent().getExtras().getBoolean("isCampMaster");
    ...
    private void connectToSignallingServer() {
        try {
            ...
            socket.on(EVENT_CONNECT, args -> {
                ...
                socket.emit("create or join", "streamcamp");
            }).on("ipaddr", args -> {
