...
public class GettingStartedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent activity2Intent = new Intent(getApplicationContext(), SelectCampsActivity.class);
    ...
    private void loadSlides(){
        ...
        gettingStartedList.add(new GettingStarted("1"));
        gettingStartedList.add(new GettingStarted("2"));
        gettingStartedList.add(new GettingStarted("3"));
