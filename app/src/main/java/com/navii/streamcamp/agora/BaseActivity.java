package com.navii.streamcamp.agora;
...
import com.navii.streamcamp.StreamCamp;
...
import com.navii.streamcamp.utils.WindowUtil;
...
public abstract class BaseActivity extends AppCompatActivity implements EventHandler {
    ...
    protected StreamCamp application() {
        return (StreamCamp) getApplication();
    }
